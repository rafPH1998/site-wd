<div class="bg-gray-200 py-8 px-48 flex-col">
    <div class="flex justify-between items-center space-x-8">
        ...
        <div class="w-full text-blue-950 text-sm flex flex-col">
            ...
            <div class="flex items-center cursor-pointer hover:text-blue-600">
                ...
                <span class="ml-1">Quem somos</span>
            </div>
            <div class="flex items-center cursor-pointer hover:text-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
        ...
        <div class="w-full text-blue-950 text-sm flex flex-col">
            <div class="flex items-center cursor-pointer hover:text-blue-600">
                ...
                <span class="ml-1">Ferramentas</span>
            </div>
            <div class="flex items-center cursor-pointer hover:text-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
        ...
        <div class="flex items-center space-x-6 w-full">
            ...
            <span class="[&>svg]:h-7 [&>svg]:w-6 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. -->
    ...
    <hr class="border-blue-950 w-full mt-8">
    <div class="mt-6 flex justify-center">
        <span class="text-xs">Copyright ©2021 Todos os Diretos Reservados</span>
    </div>
</div>